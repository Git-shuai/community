...
public class SimpleGetObjectSample {
    ...
    private static String accessKeyId = "LTAI4Foou2Fe4VSTtLfBnXxT";
    private static String accessKeySecret = "tRkxbeMI2XXRhs0YPu2gClWI6qIjDR";

    private static String bucketName = "community-fts";
